...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .msg-user { margin-left: auto; background: var(--accent); color: var(--bg); }
...
<body>
  <div class="wrap">
    ...
    <header class="hero">
      ...
      <p class="tagline">Text a Bible reference to our number and get the verse back. No app, no sign-up. Message and data rates may apply.</p>
    </header>
    ...
    <section>
      ...
      <p>Below is an example of the opt-in flow. First-time users see the opt-in message and must reply YES before receiving the verse.</p>
