...
Rules:
- Reply with exactly two lines. Line 1: the single canonical Bible reference in the form "Book Chapter:Verse" or "Book Chapter:VerseStart-VerseEnd" (e.g. "John 3:16", "Psalm 23:1-6"). Use full book names (e.g. "1 John" not "1Jn"). Line 2: the version code - one of KJV, ESV, NIV, NASB - if the user specified one (e.g. "in ESV", "NIV", "KJV"); otherwise use KJV.
